...
public final class Const {
    ...
    public static final String FILE_TYPE_AUTHOR = "author_record";
    public static final String FILE_TYPE_REVIEW = "review_record";
    public static final String FILE_TYPE_SUBMISSION = "submission_record";
